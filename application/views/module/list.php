...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"><a href="<?php echo site_url('module/add');?>">新增</a></div></td>
                  </tr>
              </table></td>
              <td width="60"><table width="90%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#c9c9c9">
      <tr>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">模块名称</span></strong></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">创建时间</span></strong></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">所属菜单</span></strong></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><strong><span class="STYLE1">所属用户</span></strong></div></td>
      ...
      <tr>
        ...
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a href="<?php echo site_url('module/moduleMappingMenu/uuid/').'/'.$v['uuid'];?>">关联菜单</a></span></div></td>
        <td height="22" bgcolor="#FFFFFF"><div align="center"><span class="STYLE3"><a href="<?php echo site_url('module/moduleMappingMenu/uuid/').'/'.$v['uuid'];?>">关联用户</a></span></div></td>
